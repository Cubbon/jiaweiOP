...
class ControllerModuleBossMegamenu extends Controller {
	...
	public function index() {   
		...
		$this->document->addStyle('view/stylesheet/boss_megamenu.css');
 
		$this->document->addScript('view/javascript/bossthemes/jquery.nestable.js');
	...
	public function info(){
		...
		$this->data['thumb'] = $this->model_tool_image->resize($icon['icon'], 50, 50);
