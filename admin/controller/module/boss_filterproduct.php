...
class ControllerModuleBossFilterProduct extends Controller {
	...
	public function install() 
	{
		...
		$array_heading1 = array();
		$array_heading2 = array();
		$array_heading3 = array();
		$array_heading4 = array();
	
		
		foreach($languages as $language){	
			$array_heading1{$language['language_id']} = 'New Products';	
			$array_heading2{$language['language_id']} = 'Popular Products';	
			$array_heading3{$language['language_id']} = 'Special Product';	
			$array_heading4{$language['language_id']} = 'Best Seller';	
		}
		
		
		$boss_filterproduct = array('boss_filterproduct_module' => array ( 0 => array(
			'image_width' => 148,
			'image_height' =>148 ,
			'limit' => 15,
			...
			'store_id' => array(0=>0),
			'tabs' => array(
				0 => array('title' => $array_heading1,   'type_product' => 'latest'),
				1 => array('title' => $array_heading2,  'type_product' => 'popular'),
				2 => array('title' => $array_heading3,  'type_product' => 'special'),
				3 => array('title' => $array_heading4,  'type_product' => 'best_seller')
				)
			)));

		$this->model_setting_setting->editSetting('boss_filterproduct', $boss_filterproduct);		
	}	
}
?>