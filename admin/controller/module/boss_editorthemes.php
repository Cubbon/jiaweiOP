...
class ControllerModuleBossEditorthemes extends Controller {
	...
	public function getModules( $layout_id ){
		...
		$this->load->model('setting/boss_editorthemes');
		$extensions = $this->model_setting_boss_editorthemes->getExtensions('module');		
		$module_data = array();
	...
	public function index() {   
		...
		$this->data['entry_back_body_image'] = $this->language->get('entry_back_body_image');
	...
	public function install() {
        $data = array(
			'boss_editorthemes_module' => array(0 => array('layout_id' => 9999, 'position' => 'header', 'sort_order' => 0, 'status' => 1)),
			'b_Color_Data' => Array (
				'g_bg_image' => 'default',
				'g_upload_bg_image' => '',
				'g_bg_image_repeat' => 'repeat',
				'g_bg_image_position' => 'left top',
				'gbox_bg_image' => 'default',
				'gbox_upload_bg_image' => '',
				'gbox_bg_image_repeat' => 'repeat',
				'gbox_bg_image_position' => 'left top',
				'h_bg_image' => 'default',
				'h_upload_bg_image' =>'',
			...
			'b_General_Respon' => 1,
			'b_General_Show' => 1,
			'b_Layout_Setting' => '20,100-80-60,20-25-33',
			'b_Mode_CSS' => 'wide',
			'b_Setting' =>  Array ('temp_setting' => 'custom' ),
			'customcode' => array('custom_css' => '', 'custom_java' => ''),
			'elayout_id' => 1
		);
