...
//boss_quickshop
	public function install() 
	{
		...
		0 => array ( 'array_class_selected' =>  '.product-list&gt;div, .product-grid&gt;div, .box-product&gt;li&gt;.product_review', 'width' => 800, 'height' => 800, 'text' => $array_description0, 'layout_id' => $this->getIdLayout("category"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		1 => array ( 'array_class_selected' =>  '.product-list&gt;div, .product-grid&gt;div, .box-product&gt;li&gt;.product_review',  'width' => 800, 'height' => 800, 'text' => $array_description0, 'layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		2 => array ( 'array_class_selected' =>  '#product_related&gt;li, .box-product&gt;li&gt;.product_review',  'width' => 800, 'height' => 800, 'text' => $array_description0, 'layout_id' => $this->getIdLayout("product"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		3 => array ( 'array_class_selected' =>  '.box-product&gt;li',  'width' => 800, 'height' => 800, 'text' => $array_description0, 'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		));
