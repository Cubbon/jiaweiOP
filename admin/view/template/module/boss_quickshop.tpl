        ...
        <table id="module" class="list">
          <thead>
            <tr>
			  ...
			  <td class="left"><?php echo 'Fancybox Size (WxH)'; ?></td>
            ...
            <tr>
              <td class="left">
			   ...
			   <td class="left"><input type="text" name="boss_quickshop_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                <input type="text" name="boss_quickshop_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="3" />
...
function addModule() {	
	...
	html += '</td>';
	html += '    <td class="left"><input type="text" name="boss_quickshop_module[' + module_row + '][width]" value="500" size="3" /> <input type="text" name="boss_quickshop_module[' + module_row + '][height]" value="500" size="3" /></td>'; 
	html += '<td class="left">';
	<?php foreach ($languages as $language) { ?>
