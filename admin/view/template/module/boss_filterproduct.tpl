  ...
  <div class="content">
   <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<?php foreach($modules as $module) {?>
			<a href="#tab<?php echo $module_row_t ; ?>" id="tabtitle<?php echo $module_row_t ; ?>"><?php echo $module_stt; echo $module_row_t + 1;?>&nbsp;<img src="view/image/delete.png" alt="" 
...
<?php } ?>
    ...
    function addModule() {
	  ...
	  html += '<input type="text" name="boss_filterproduct_module[' + module_row + '][image_width]" value="80" size="3" /> <input type="text" name="boss_filterproduct_module[' + module_row + '][image_height]" value="80" size="3" /></td>';
	  html += '</tr>';
	  html += '<tr><td><?php echo $entry_limit; ?></td><td class="left">';
	  html += '<input type="text" name="boss_filterproduct_module[' + module_row + '][limit]" value="20" size="3" /></td>';
	  html += '</tr>';
      ...
      html += '<td class="left"><a onclick="addTab(this,' + module_row +',1);" class="button"><?php echo $button_add_tab; ?></a></td>';
      html += '</tr></tfoot></table>';
	  html += '</div>';
	  html += '</div>';
