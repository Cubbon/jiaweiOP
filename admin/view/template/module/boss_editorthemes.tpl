								...
								<div id="tab_general_setting" class="vtabs-content">
									<div class="box">
										...
										<div class="content">
											...
											<input type="hidden" name="boss_editorthemes_module[0][position]" value="header" />
									...
									<div class="box">
										...
										<div class="content">
											<table class="form">
												...
												<tr>
													<td><input type="radio" value="33,100-66-33,33-50-100" name="b_Layout_Setting" <?php if ($b_Layout_Setting == '33,100-66-33,33-50-100') echo ' checked="checked"'; ?> /> <?php echo $text_extra; ?>
													</td>
												</tr>
												<tr>
													<td><input type="radio" value="25,100-75-50,25-33-50" name="b_Layout_Setting" <?php if ($b_Layout_Setting == '25,100-75-50,25-33-50') echo ' checked="checked"'; ?> /> <?php echo $text_large; ?>
													</td>
												</tr>
												<tr>
													<td><input type="radio" value="20,100-80-60,20-25-33" name="b_Layout_Setting" <?php if ($b_Layout_Setting == '20,100-80-60,20-25-33') echo ' checked="checked"'; ?> /> <?php echo $text_medium1; ?>
													</td>
												</tr>
												<tr>
													<td><input type="radio" value="25,100-75-50,10-20-25" name="b_Layout_Setting" <?php if ($b_Layout_Setting == '25,100-75-50,10-20-25') echo ' checked="checked"'; ?> /> <?php echo $text_small; ?>
													</td>
												</tr>
											</table>
										</div>
							...
							<td valign="top" >
								...
								<div id="tab_general_color" class="vtabs-content">
									...
									<table class="form">
										...
										<tr>
											<td><label><?php echo $entry_back_body_image; ?></label></td>
											<td>
												<div class="bg_image">
													<span class="g_bg_image" style="background:url('view/image/background/back_0.png') repeat;float:left;margin:0 10px 10px 0">
														<input type="radio" name="b_Color_Data[gbox_bg_image]" value="default" <?php if ($b_Color_Data['gbox_bg_image'] == 'default') echo ' checked="checked"'; ?> />
													</span>
													<?php foreach ($bg_images as $image => $settings) {?>
														<span class="g_bg_image" style="background:url('view/image/background/<?php echo $settings; ?>') repeat;float:left;margin:0 10px 10px 0">
														<input type="radio" name="b_Color_Data[gbox_bg_image]" value="<?php echo$settings; ?>" <?php if ($b_Color_Data['gbox_bg_image'] == $settings) echo ' checked="checked"'; ?> /> </span>
													<?php }?>
													<span><input type="radio" name="b_Color_Data[gbox_bg_image]" value="gbox_upload_bg_image" <?php if ($b_Color_Data['gbox_bg_image'] == 'gbox_upload_bg_image') echo ' checked="checked"'; ?> /><?php echo $text_upload_image; ?></span>
												</div>
												<div class="upload_image">
													<?php if(($b_Color_Data['gbox_upload_bg_image'])!=''){ ?>
														<img src="../image/<?php echo $b_Color_Data['gbox_upload_bg_image']; ?>" width="100px" height="50px" alt="" id="gbox_thumb" />
													<?php } ?>
													<?php if($b_Color_Data['gbox_upload_bg_image']==''){ ?>
														<img src="<?php echo $no_image; ?>" id="gbox_thumb" />
													<?php } ?>
													<input type="hidden" name="b_Color_Data[gbox_upload_bg_image]" value="<?php echo $b_Color_Data['gbox_upload_bg_image']; ?>" id="gbox_image" />
													  <br />
													<a onclick="image_upload('gbox_image', 'gbox_thumb');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#gbox_thumb').attr('src', '<?php echo $no_image; ?>'); $('#gbox_image').attr('value', '');"><?php echo $text_clear; ?></a>
												</div>
												<div class="image_repeat" style="clear:both;">
													<span><?php echo $entry_repeat; ?></span>
													<select name="b_Color_Data[gbox_bg_image_repeat]">
														<option value="repeat"<?php if ($b_Color_Data['gbox_bg_image_repeat'] == 'repeat') echo ' selected="selected"'; ?>><?php echo $text_repeat; ?></option>
														<option value="no-repeat"<?php if ($b_Color_Data['gbox_bg_image_repeat'] == 'no-repeat') echo ' selected="selected"'; ?>><?php echo $text_no_repeat; ?></option>
														<option value="repeat-x"<?php if ($b_Color_Data['gbox_bg_image_repeat'] == 'repeat-x') echo ' selected="selected"'; ?>><?php echo $text_repeat_x; ?></option>
														<option value="repeat-y"<?php if ($b_Color_Data['gbox_bg_image_repeat'] == 'repeat-y') echo ' selected="selected"'; ?>><?php echo $text_repeat_y; ?></option>
														
													</select>
												</div><br />
												<div class="image_repeat" style="clear:both;">
													<span><?php echo $entry_position_image; ?></span>
													<select name="b_Color_Data[gbox_bg_image_position]">
														<option value="left top"<?php if ($b_Color_Data['gbox_bg_image_position'] == 'left top') echo ' selected="selected"'; ?>><?php echo $text_left_top; ?></option>
														<option value="right top"<?php if ($b_Color_Data['gbox_bg_image_position'] == 'right top') echo ' selected="selected"'; ?>><?php echo $text_right_top; ?></option>
														<option value="center top"<?php if ($b_Color_Data['gbox_bg_image_position'] == 'center top') echo ' selected="selected"'; ?>><?php echo $text_center_top; ?></option>
														<option value="center center"<?php if ($b_Color_Data['gbox_bg_image_position'] == 'center center') echo ' selected="selected"'; ?>><?php echo $text_center_center; ?></option>
													</select>
												</div>
											</td>
										</tr>
