...
$_['entry_tax_default']          = '使用商店所在地税率：<br /><span class="help">非注册用户使用商店所在地税率。 您可以使用商店所在地税率计算税费。</span>';
$_['entry_tax_customer']         = '使用客户所在地税率：<br /><span class="help">注册客户使用客户所在地税率。 您可以使用商店所在地税率计算税费。</span>';
...
$_['entry_stock_warning']        = '显示缺货警告：<br /><span class="help">在购物车页面中显示缺货信息。 如果一个商品已经卖完了， 但‘缺货结账’是肯定的。(警告总在‘缺货结账’是否定时显示)</span>';
$_['entry_stock_checkout']       = '缺货结账：<br /><span class="help">如果客户订购的商品不存在仓库，仍然允许结账。</span>';
...
$_['entry_account_mail']         = '新帐户邮件提醒：<br /><span class="help">当有新用户注册时，发送邮件通知店主。</span>';
$_['entry_alert_mail']           = '新订单邮件提醒：<br /><span class="help">创建新订单时给店主发送邮件。</span>';
$_['entry_alert_emails']         = '附加通知邮箱：<br /><span class="help">任何您想收到本站邮件的额外信箱。 (请用逗号分开)</span>';
$_['entry_fraud_detection']      = '使用MaxMind欺诈检测系统：<br /><span class="help">MaxMind是一个欺诈检测服务。如果您没有一个许可证密钥，您可以<a onclick="window.open(\'http://www.maxmind.com/?rId=opencart\');"><u>注册这里</u></a>。一旦您已经获得了密钥，请复制并粘贴到下面。</span>';
...
$_['entry_secure']                 = '使用 SSL：<br /><span class="help">检查您的服务器是否安装了SSL认证，如果安装了，可以使用SSL。</span>';
$_['entry_shared']                 = '多网店共享Sessions：<br /><span class="help">您可以让各个网店之间的购物车共享数据。</span>';
$_['entry_robots']                 = '爬虫/机器人：<br /><span class="help">加入不受欢迎的爬虫/机器人。</span>';
//$_['entry_use_ssl']              = '使用 SSL：<br /><span class="help">要使用SSL, 您需要在您的服务安装SSL及在设定档有SSL地址。</span>';
$_['entry_seo_url']              = '使用SEO URL\'s：<br /><span class="help">要使用搜索引擎优化网址\'s 您的服务器必须支持 Apache Rewrite Mod 功能，在启用此项功能前您需要重新命名 htaccess.txt 文件为 .htaccess</span>';
...
$_['entry_maintenance']          = '系統维护模式：<br /><span class="help">本功能将在前台首页显示系统维护信息。 但在后台您可以正常使用本系统。</span>';
...
$_['error_voucher_min']            = '必须填写最小礼品券数！';
$_['error_voucher_max']            = '必须填写最大礼品券数！';
...
$_['error_ftp_host']               = 'FTP 主机 必须!';
$_['error_ftp_port']               = 'FTP 端口 必须!';
$_['error_ftp_username']           = 'FTP 用户名 必须!';
$_['error_ftp_password']           = 'FTP 密码 必须!';
