...
// Entry
$_['entry_url']                 = '网店网址：<br /><span class="help">请输入您网店的完整网址。 注意在最后加上 \'/\' 。 例： http：//www.yourdomain.com/path/<br /><br />请用新的域名或二级域名指定到您的主机。</span>';
...
$_['entry_tax']                 = '显示含税价：';
$_['entry_tax_default']         = '使用商店所在地税率：<br /><span class="help">非注册会员使用商店所在地税率。 您可以使用商店所在地税率计算税费。</span>';
$_['entry_tax_customer']        = '使用会员所在地税率：<br /><span class="help">注册会员使用会员所在地税率。 您可以使用商店所在地税率计算税费。</span>';
...
$_['entry_secure']              = '使用 SSL:<br /><span class="help">请确认您已经安排了SSL证书。</span>';

//$_['entry_use_ssl']             = '使用 SSL：<br /><span class="help">请确认您已经安排了SSL证书。</span>';
