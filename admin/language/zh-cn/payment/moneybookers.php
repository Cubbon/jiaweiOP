...
// Text 					
$_['text_payment']		      = '支付管理';
$_['text_success']		      = '成功：您修改了Moneybookers的详细资料。';
...
$_['entry_chargeback_status']   = '交易糾紛：'; //'Chargeback Status:';
$_['entry_geo_zone']            = '区域群组：';
$_['entry_status']              = '状态：';
$_['entry_sort_order']          = '排序：';

// Error					
$_['error_permission']	      = '警告： 您没有权限修改 Moneybookers支付模块！';
$_['error_email']		      = '必须填写电子邮箱！';
?>