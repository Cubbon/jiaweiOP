...
$_['text_amazon_order_id']    = 'Amazon 订单ID:';//
$_['text_name']               = '名称:';//
...
$_['text_tax_id']             = '公司税号：';
$_['text_address_1']          = '地址一：';
$_['text_address_2']          = '地址二：';
...
$_['text_high_risk_country']                  = '高风险国家：<br /><span class="help">IP地址或帐单地址国家是加纳，尼日利亚，越南</span>';
$_['text_distance']                           = '距离<br /><span class="help">从IP地址与开单地点的距离以公里显示(愈远的距离=愈高风险).</span>';
$_['text_ip_region']                          = 'IP 地址：<br /><span class="help">估计IP地址的国家/地区.</span>';
$_['text_ip_city']                            = 'IP 城市：<br /><span class="help">估计IP地址的城市.</span>';
$_['text_ip_latitude']                        = 'IP 纬度：<br /><span class="help">估计IP地址的纬度.</span>';
$_['text_ip_longitude']                       = 'IP 经度：<br /><span class="help">估计IP地址的经度.</span>';
$_['text_ip_isp']                             = 'ISP：<br /><span class="help">ISP的IP地址。</span>';
$_['text_ip_org']                             = 'IP 组织：<br /><span class="help">IP地址的组织.</span>';
$_['text_ip_asnum']                           = 'ASNUM：<br /><span class="help">估计IP地址的自治系统号码.</span>';
$_['text_ip_user_type']                       = 'IP 会员类型：<br /><span class="help">估计IP地址的用户类型.</span>';
$_['text_ip_country_confidence']              = 'IP 国家信用：<br /><span class="help">该国的位置是正确的.</span>';
$_['text_ip_region_confidence']               = 'IP 地区信用：<br /><span class="help">该地区的位置是正确的.</span>';
$_['text_ip_city_confidence']                 = 'IP 市场信用：<br /><span class="help">这个城市的位置是正确的.</span>';
$_['text_ip_postal_confidence']               = 'IP 邮政信用：<br /><span class="help">邮政编码位置是正确的.</span>';
$_['text_ip_postal_code']                     = 'IP 邮政编码：<br /><span class="help">估计IP地址的邮政编码.</span>';
$_['text_ip_accuracy_radius']                 = 'IP 精准度：<br /><span class="help">以英里计算最终用户的实际位置和GeoIP的的城市数据库的IP地址的平均距离</span>';

$_['text_ip_net_speed_cell']                  = 'IP 网络类型：<br /><span class="help">估计IP地址的网络类型.</span>';
...
$_['text_ip_time_zone']                       = 'IP 时区：<br /><span class="help">估计IP地址的时区.</span>';
$_['text_ip_region_name']                     = 'IP 地区名：<br /><span class="help">估计IP地址的地区名称.</span>';
$_['text_ip_domain']                          = 'IP 域：<br /><span class="help">估计IP地址的域名.</span>';
$_['text_ip_country_name']                    = 'IP 国家名称：<br /><span class="help">估计IP地址的国家名称</span>';
...
$_['text_free_mail']                          = '免费邮箱：<br /><span class="help">电子邮件是从免费邮箱提供商（免费邮箱=高风险）.</span>';
$_['text_carder_email']                       = 'Carder Email：<br /><span class="help">电子邮件是在高风险的电子邮件数据库.</span>';
...
$_['error_shipping']          = '警告：必须填写货运方式！';
$_['error_payment']           = '警告：必须填写支付方式！';
