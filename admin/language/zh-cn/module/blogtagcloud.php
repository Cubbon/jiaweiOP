...
// Heading
$_['heading_title']    			= 'gp - 博客标签云';

// Text
$_['text_module']         = '模块管理';
$_['text_success']        = '成功： 您已成功修改 博客标签云 模块！';
...
$_['entry_layout']        = '布局：';
$_['entry_limit']         = '显示数量：';
$_['entry_min_font_size']	= '最小尺寸:';
$_['entry_max_font_size']	= '最大尺寸:';
$_['entry_font_weight'] 		= '字体粗细:';
$_['entry_position']      = '显示位置：';
$_['entry_status']        = '状态：';
$_['entry_sort_order']    = '排序：';

// Error
$_['error_permission']		= '警告: You do not have permission to modify module gp 博客标签云!';
?>