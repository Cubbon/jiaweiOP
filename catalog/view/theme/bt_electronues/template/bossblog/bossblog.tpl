...
<div id="content"><div class="boss_frame"><?php echo $content_top; ?>
    ...
    <?php if ($articles) { ?>
        <div class="article-filter">
			...
			<div class="rss-feed">
				<a href="<?php echo $link_rss; ?>" title='RSS'><img src='catalog/view/theme/bt_electronues/image/bossblog/rss.png' alt='Subscribe' /></a>
			</div>          
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo $text_display; ?></b><a class="no-active-gird" title="<?php echo $text_grid; ?>" onclick="display(\'grid\');"><?php echo $text_grid; ?></a><span class="active-list" title="<?php echo $text_list; ?>"><?php echo $text_list; ?> </span>');
		...
		$('.display').html('<b><?php echo $text_display; ?></b><span title="<?php echo $text_grid; ?>" class="active-gird"><?php echo $text_grid; ?></span><a class="no-active-list" title="<?php echo $text_list; ?>" onclick="display(\'list\');"><?php echo $text_list; ?></a>');
