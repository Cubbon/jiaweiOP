			...
			<ul>
				<?php foreach($slides as $slide) { ?>
					...
					<?php if ($slide['type_background'] == "color_bg") { ?>
						<img src="image/data/transparent.png" style="background-color:<?php echo $slide['background'];?>"  alt="" />
					<?php }else{ ?>
						<img src="<?php echo $slide['background'];?>"  alt="" />
					<?php } ?>
...
if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/boss_revolutionslider/css/settings.css')) {
			echo '<link rel="stylesheet" type="text/css" href="catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/boss_revolutionslider/css/settings.css" />';
		} else {
			echo '<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/boss_revolutionslider/css/settings.css" />';
		}
?>
</div>
<!--Revolution slider-->