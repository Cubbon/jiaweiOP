...
$_['text_next_choice']       = '选择使用折扣券， 或奖励奖励积分， 或预估货运成本';
$_['text_use_coupon']        = '使用折扣券';
$_['text_use_voucher']       = '使用礼品券';
$_['text_use_reward']        = '使用奖励积分(有效奖励积分 %s)';
$_['text_shipping_estimate'] = '运费 &amp; 税费预估';
$_['text_shipping_detail']   = '请输入您的货运目的地获取预估运费。';
$_['text_shipping_method']   = '请选择您希望使用的货运方式。';
$_['text_empty']             = '您的购物车内没有商品！';
$_['text_until_cancelled']   = '直到取消：';
$_['text_recurring_item']    = '分期付款商品';
$_['text_payment_profile']   = '分期付款方式';
$_['text_trial_description'] = '%s 每 %d %s(s) 给 %d 付款后';
...
$_['error_reward']           = '警告： 请输入需要使用的奖励积分！';	
$_['error_points']           = '警告： 您没有 %s 奖励积分！';
$_['error_maximum']          = '警告： 最大可使用奖励积分为%s！';
$_['error_postcode']         = '邮政编码必须在2到10字符之间！';
