  	...
  	public function index() {
		...
		if (isset($this->session->data['shipping_postcode'])) {
			...
			$this->data['postcode'] = '';
                ...
                if(isset($this->session->data['datanum'])){
                    $this->data['datanum']=$this->session->data['datanum'];
                }else{
                    $this->data['datanum']='2';
                }
		...
		if (!$json) {					
			if ((utf8_strlen($this->request->post['firstname']) < 1) || (utf8_strlen($this->request->post['firstname']) > 32)) {
				$json['error']['firstname'] = $this->language->get('error_firstname');
                        ...
                        if(is_numeric(utf8_strlen($this->request->post['telephone']))){
                            if ((utf8_strlen($this->request->post['telephone']) < 3) || (utf8_strlen($this->request->post['telephone']) > 32)) {
                                $json['error']['telephone'] = $this->language->get('error_telephone');
                            }
                        }else{
                            if ((utf8_strlen($this->request->post['telephone']) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['telephone'])) {
