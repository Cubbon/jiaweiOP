				...
				if ($category['top']) {
					...
					foreach ($children as $child) {
						...
						$children_data[] = array(
							...
							'href'  => $this->url->link('product/category', 'path=11s' . $category['category_id'] . '_' . $child['category_id'])
						);						
					}
					// Level 1
					$this->data['categories'][] = array(
											...
											if($category_id!=''){
												...
												foreach ($results as $category) {
													$contents[] = array(
														...
														'href'     		=> $this->url->link('product/category', 'path='.$category_parent_id.'_'.$category_id.'_' . $category['category_id'])
													);
												}
											}
										}
